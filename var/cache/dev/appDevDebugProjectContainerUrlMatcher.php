...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/public-web/articles')) {
            ...
            // vallbona_web_detall_articles
            if (preg_match('#^/public\\-web/articles/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'vallbona_web_detall_articles')), array (  '_controller' => 'Vallbona\\WebBundle\\Controller\\DefaultController::articlesDetallAction',));
            }
